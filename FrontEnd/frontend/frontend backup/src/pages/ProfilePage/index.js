  ...
  navigate("/uploadedproductbyuser")
    ...
    return (
        ...
        <div>
            ...
            <hr />
            <h1 className='text-center mt-3 pt-1' id='allproduct'>{user.firstName} Profile</h1>
            <hr />
                    ...
                    <div className="row">
                        <div className="col">
                            {user.role == "Vendor" &&
                                <div>
                                    <div className="row">
                                        <button type="button" id='xbtn' class="btn btn-dark" onClick={naviagettoaddproduct}>Insert Product</button>
                                    </div>
                    
                                    <div className='row'>
                                        <button type="button" id='xbtn' class="btn btn-dark" onClick={uploadedproductbyuser}> Products By me </button>
                                    </div>
                                </div>
                            ...
                            {user.role == "Customer" &&
                                <div class="d-grid gap-2 col-6 mx-auto" id='xbtn'>
                                    <button class="btn btn-warning" type="button" onClick={addAddressByid}>Address</button>
                            ...
                            {user.role == "Admin" &&
                                <div class="d-grid gap-2 col-6 mx-auto" id='xbtn'>
                                    <button class="btn btn-warning" type="button" onClick={addCategory}>Add category-subcategory</button>
